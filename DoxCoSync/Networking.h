...
namespace f4mp
{
    ...
    {
        class Networking;
        class Entity;    //forward declaration so MessageOptions can use Entity*
        ...
        protected:
            ...
            virtual void _Read(void* value, std::size_t size) = 0;
            virtual void _Write(const void* value, std::size_t size) = 0;
        };
        ...
        public:
            ...
            using InstantiationID = std::int32_t;
		...
		public:           //Was Protected
            struct _Interface
            {
                ...
                virtual void SendMessage(Event::Type messageType,
                    const EventCallback& callback,
                    const MessageOptions& options) = 0;
            };
        ...
        public:
            ...
            void SendMessage(Event::Type messageType,
                const EventCallback& callback,
        ...
        public:
            ...
            virtual void Start(const std::string& address, std::int32_t port) = 0;
            virtual void Stop() = 0;
        ...
        protected:
            ...
            Entity* Instantiate(Entity::InstantiationID instantiationID,
                Entity::ID entityID,
